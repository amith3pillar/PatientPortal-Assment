...
public class PPHomePageOR {
	...
	//public static final String REQUEST_AN_APPOINTMENT="//span[contains(text(),'Request an appointment')]";
	public static final String REQUEST_AN_APPOINTMENT="//button[@id='sendApptRequest']/span[contains(text(),'Request an appointment')]";
